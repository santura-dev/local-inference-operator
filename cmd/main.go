...
import (
	...
	"github.com/santura-dev/local-inference-operator/internal/controller"
...
func main() {
	...
	//
	// With cert-manager enabled, uncomment the following lines:
	...
	mgr, err := ctrl.NewManager(ctrl.GetConfigOrDie(), ctrl.Options{
		...
		LeaderElectionID:       "36bc56e6.local-ome.com",
	...
	if err := (&controller.LocalInferenceServiceReconciler{
		Client: mgr.GetClient(),
		Scheme: mgr.GetScheme(),
	}).SetupWithManager(mgr); err != nil {
		setupLog.Error(err, "unable to create controller", "controller", "LocalInferenceService")
		os.Exit(1)
	}
